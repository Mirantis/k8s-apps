...
{{- printf "fission-%s" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "fission-controller" -}}
{{- printf "fission-controller-%s" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "fission-router" -}}
{{- printf "fission-router-%s" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "fission-poolmgr" -}}
{{- printf "fission-poolmgr-%s" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "fission-kubewatcher" -}}
{{- printf "fission-kubewatcher-%s" .Release.Name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
